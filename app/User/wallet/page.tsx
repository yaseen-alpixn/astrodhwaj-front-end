  ...
  return (
    <main className="bg-white px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-6 xl:flex-row xl:items-start">
        {/* Balance Card */}
        <section className="rounded-xl bg-[#fbf1ff] p-5 shadow-sm xl:flex-[1.2] xl:mt-12 xl:p-10">
          ...
          <button className="mt-5 flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#efca00] text-sm font-medium text-white hover:opacity-90">
        ...
        <section className="xl:flex-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            {rechargePacks.map((pack) => (
              ...
              >
                {pack.isPopular && (
                  <span className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 rounded-full bg-yellow-400 px-3 py-1 text-xs font-medium">
                    Popular
                  </span>
                )}
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <Image
                    ...
                    width={18}
                    height={18}
                    alt={entry.type === "credit" ? "Credit transaction" : "Debit transaction"}
                  />
                </div>
