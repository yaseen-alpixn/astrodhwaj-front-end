          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_380px]">
            <section className="space-y-8">
                ...
                <div className="mt-5 grid gap-x-1 gap-y-1 sm:grid-cols-2">
                  {courseLearnPoints.map((item) => (
                    <div key={item} className="flex items-start gap-2">
                      <Check
                        className="mt-1 h-5 w-6 shrink-0 text-[#7b18cb]"
                        strokeWidth={3}
                      />
              ...
              <section>
                ...
                <button
                  type="button"
                  className="mt-5 text-[13px] font-medium text-[#7b18cb]"
                >
                  20 more contents
                </button>
              </section>
              ...
              <section>
                ...
                <button
                  type="button"
                  className="mt-4 text-[13px] font-medium text-[#7b18cb]"
                >
                  Show more
                </button>
              </section>
              <section className="border-t border-[#d9d9d9] pt-8">
                ...
                <div className="mt-3 flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(135deg,#e8d7ff_0%,#f5efff_100%)] text-[11px] font-medium text-[#7b18cb]">
                    VB
                  </div>
                  <div>
