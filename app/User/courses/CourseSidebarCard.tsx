    ...
    <aside className="rounded-[20px] h-2/5 border border-[#ece3f7] bg-white p-3  sm:p-5">
      ...
      <div className="mt-1 overflow-hidden rounded-[10px] border border-[#dbd3e8] bg-white">
        <div className="grid grid-cols-1 items-stretch divide-y divide-[#e9e1f2] sm:grid-cols-[100px_auto_1fr_1fr] sm:divide-x sm:divide-y-0">
          <div className="flex flex-col items-center justify-center bg-gradient-to-b from-[#0085FF] to-[#DD9A29]  text-center text-white">
            <Image
      ...
      <div className="mt-2 space-y-4">
        <button
          type="button"
          className="inline-flex h-10 w-full items-center justify-center rounded-[16px] bg-[#4898E1] text-[1rem] font-semibold text-white transition-colors hover:bg-[#4898E1]/90"
        >
          Buy Course
        </button>
        <button
          type="button"
          className="inline-flex h-10 w-full items-center justify-center rounded-[16px] border border-[#4898E1] bg-white text-[1rem] font-semibold text-[#171717] transition-colors hover:bg-[#E8F4FF]"
        >
          Add To Cart
        </button>
      </div>
