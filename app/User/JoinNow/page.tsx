  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-lg">
        {/* Header */}
        <h2 className="mb-4 text-[18px] font-semibold text-purple-700">
          Complete Payment
        </h2>
        ...
        <div className="mb-6 flex items-start justify-between">
          ...
          <p className="text-[20px] font-bold text-purple-700">₹{amount}</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <button
            onClick={onPayNow}
            className="w-full rounded-full bg-purple-700 py-3 text-white hover:bg-purple-800"
          >
            Pay Now
          </button>
          <button
            onClick={onCancel}
            className="w-full rounded-full border-2 border-purple-700 py-3 text-gray-900 hover:bg-gray-50"
          >
            Cancel
          </button>
        </div>
