      ...
      <header className="flex items-center justify-between gap-4 border-b border-[#f1ecf7] px-3 py-2 sm:px-6">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-[11px] font-medium text-[#4f4a57]">Online</p>
          </div>
        </div>
              ...
              <div
                className={
                  isUser
                    ...
                    : "w-fit max-w-full min-w-[140px] rounded-[18px] rounded-bl-[8px] bg-[#efefef] px-4 py-4 text-[13px] font-normal leading-[22px] text-[#171717] shadow-[0_8px_24px_rgba(17,17,17,0.04)] sm:min-w-[220px] lg:min-w-[320px]"
                }
              >
                {message.content}
              </div>
      ...
      <footer className="mt-auto border-t border-[#f1ecf7] px-3 py-2 sm:px-6">
        <form className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#7717c5] text-white shadow-[0_12px_30px_rgba(119,23,197,0.26)]"
          >
