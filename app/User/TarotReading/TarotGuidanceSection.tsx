  ...
  return (
    <section className="space-y-6">
      <div className="space-y-4">
        <div className="inline-flex h-15 w-15 items-center justify-center rounded-full bg-[#f4c500] text-white ">
      ...
      <div className="space-y-3.5">
        {tarotCategories.map(
          ({
            ...
            <article
              key={title}
              className={`flex items-center gap-3 rounded-[18px] px-4 py-4 text-white  sm:px-5 ${gradientClassName}`}
            >
              <div
