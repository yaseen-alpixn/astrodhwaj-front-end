...
function SectionButtons() {
  return (
    <div className="grid gap-2 sm:grid-cols-3">
      <button className="rounded-[8px] bg-[#4898E1] px-4 py-3 text-[13px] font-medium text-white">
        Get Kundali Matching
      </button>
      <button className="rounded-[8px] border border-[#4898E1] px-4 py-3 text-[12px] font-medium ">
        Consult Expert
      </button>
      <button className="rounded-[8px] border border-[#4898E1] px-4 py-3 text-[12px] font-medium ">
        Download
    ...
    <section className="space-y-3">
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        {dashaCards.slice(0, 2).map((card) => (
          <article
            key={card.title}
            className="rounded-[14px] border border-[#e7dff2] bg-[linear-gradient(90deg,#CCF7FF_0%,#E1E6FF_100%)] p-3 shadow-[0_10px_24px_rgba(32,17,56,0.04)]"
          >
            <div className="flex items-start justify-between gap-3">
              ...
              {card.badge ? (
                <span className="rounded-full bg-[#4898E1] px-3 py-1 text-[11px] font-medium text-white">
                  {card.badge}
                </span>
              ) : null}
            </div>
  ...
  return (
    <section className="space-y-4 mt-4">
      ...
      <div className="rounded-[8px] bg-[linear-gradient(90deg,#CCF7FF_0%,#E1E6FF_100%)] px-3 py-3">
        <h3 className="text-[14px] font-medium text-[#4898E1]">
          Remedies Suggested:
        </h3>
  ...
  return (
    <section className="space-y-4">
          ...
          >
            ...
            <div className="mt-4 flex items-end gap-3">
              <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-[#f1f1f1]">
                <div className="h-full w-[85%] rounded-full bg-[linear-gradient(90deg,#0085FF_0%,#DD9A29_100%)]" />
              </div>
              <div className="text-right">
                <p className="text-[11px] font-medium text-[#8a8095]">
                  Strength
                </p>
                <p className="text-[14px] font-medium text-[#4898E1]">
                  {planet.strength}%
                </p>
              </div>
            </div>
      ...
      <div className="grid max-w-[520px] gap-2 sm:grid-cols-2">
        ...
        <button className="rounded-[8px] border border-[#4898E1] px-4 py-3 text-[12px] font-medium  text-black">
          Download
        </button>
      </div>
    </section>
