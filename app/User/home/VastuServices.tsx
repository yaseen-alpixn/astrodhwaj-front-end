        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {cards.map((card, index) => (
            ...
            >
              ...
              <div className="my-4 lg:mt-5">
                ...
                <ul className="space-y-1">
                  {[1, 2, 3, 4, 5].map((item) => (
                    ...
                    >
                      <span className="w-2 h-2 rounded-full  bg-[#4898E1]"></span>
              ...
              {/* BUTTON */}
              <button className=" lg:mt-auto w-full h-[45px] lg:h-[50px] rounded-[10px] bg-[#DD9A29] text-white text-[13px] font-medium hover:opacity-90 transition">
                Book Now
              </button>
            </div>
          ))}
