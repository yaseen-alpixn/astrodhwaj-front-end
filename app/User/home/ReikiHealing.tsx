          ...
          >
            ...
            <div className="p-4 flex flex-col gap-2 flex-grow">
              <div className="flex items-center gap-2">
                <span className="text-[20px] font-bold text-purple-700">
                  ₹{plan.price}
                </span>
                <span className="text-[12px] font-normal text-gray-500">/30 min</span>
              </div>
              ...
              <div className="mt-2">
                ...
                <div className="flex flex-wrap gap-1">
                  <span className="px-3 py-1 text-[11px] font-medium bg-blue-100 text-blue-700 rounded-full whitespace-nowrap">
                    Stress Relief
                  </span>
                  <span className="px-3 py-1 text-[11px] font-medium bg-blue-100 text-blue-700 rounded-full whitespace-nowrap">
                    Emotional Healing
              ...
              <button className="mt-4 bg-gradient-to-r from-purple-700 to-purple-500 text-white py-2 rounded-lg text-[13px] font-medium hover:opacity-90 transition">
                Book Session
              </button>
            </div>
          </div>
