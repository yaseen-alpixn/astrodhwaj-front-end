    ...
    <section className="mt-12 pb-6 w-full">
      <div className="mx-auto px-3 sm:px-4">
        <div className="flex items-center gap-1 text-[#171717]">
          <Star className="h-5 w-5 text-[#7b1bc4]" strokeWidth={2} />
            ...
            >
              ...
              <div className="mt-4 sm:mt-5 flex flex-col flex-grow ">
                ...
                <div className="my-3 flex flex-wrap items-center gap-2">
                  ...
                  <span className="text-[13px] font-medium text-[#7b1bc4]">
                    {astrologer.price}
                  </span>
                ...
                <button
                  type="button"
                  className="mt-1 inline-flex h-8 sm:h-10 w-full items-center justify-center rounded-[12px] border border-[#8c2bdf] bg-white px-4 text-[13px] font-medium text-[#171717] transition-colors hover:bg-[#faf7ff]"
                >
                  View Profile
                </button>
              </div>
