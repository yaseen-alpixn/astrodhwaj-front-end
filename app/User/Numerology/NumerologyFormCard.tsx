...
export default function NumerologyFormCard() {
  ...
  return (
    <section className="rounded-[24px] border border-[#f0eaf7] bg-white px-5 py-6 shadow-[0_20px_60px_rgba(83,52,126,0.08)] sm:px-6 lg:px-8 lg:py-7">
      ...
      <div className="mt-5 flex justify-center">
        <button
          type="button"
          className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[12px] bg-[#f6c900] px-7 py-3 text-[13px] font-medium text-white shadow-[0_14px_30px_rgba(246,201,0,0.24)] transition-transform hover:translate-y-[-1px] sm:min-w-[264px]"
        >
