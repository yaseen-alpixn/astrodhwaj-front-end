    ...
    <div className=" rounded-b-lg space-y-4 bg-white p-3">
      {Array(5)
        ...
        .map((_, i) => (
          <div
            key={i}
            className="flex flex-col gap-3 rounded-[10px] shadow-sm bg-gray-50 p-5 lg:flex-row lg:items-center lg:justify-between"
          >
            {/* Left */}
            <div className="flex items-start gap-4">
              ...
              <div className="w-[50px] h-[50px] rounded-full bg-gradient-to-br from-yellow-100 to-[#4898E1]/10 flex items-center justify-center">
                <span className="font-medium text-[#4898E1]">PS</span>
              </div>
