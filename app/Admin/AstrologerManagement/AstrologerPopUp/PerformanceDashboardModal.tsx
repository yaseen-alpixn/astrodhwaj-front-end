      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="w-full max-w-[1100px] max-h-[90vh] overflow-y-auto rounded-xl bg-white p-6 font-[DM_Sans] shadow-lg">
          ...
          <div className="mt-4 flex items-center gap-4 rounded-lg border p-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#4898E1] text-white">
              <User />
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={i}
                className="rounded-xl border border-[#4898E1]/30 bg-[#4898E1]/10 p-4"
              >
                <div className="mb-2 text-[#4898E1]">{item.icon}</div>
            ...
            <div className="rounded-xl border p-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Hindi", "English", "Gujarati"].map((item, i) => (
                  <span
                    key={i}
                    className="rounded-full bg-[#4898E1]/10 px-3 py-1 text-sm"
                  >
                    {item}
                  </span>
                ))}
