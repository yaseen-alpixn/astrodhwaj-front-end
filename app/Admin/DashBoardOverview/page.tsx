...
export default function Page() {
  ...
  return (
    <>
      <AdminTopHeader />
      <main className="min-h-screen py-8 pl-5 pr-2 bg-violet-50  font-sans">
        <div className="max-w-[1500px] mx-auto space-y-5">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <button className="flex h-[42px] w-full items-center justify-center rounded-lg border gap-1 shadow-sm bg-violet-50 p-[18px] text-[14px] font-medium md:w-[170px]">
            ...
            {stats.map((item, i) => (
              ...
              >
                <div className="flex items-center  gap-3">
                  <div className="w-[40px] h-[40px] shrink-0 rounded-lg text-violet-700 bg-[#F3E1FF] flex items-center justify-center">
                    <Image
                      src={item.src}
                      width={15}
                      height={15}
          ...
          <div className="bg-white rounded-xl p-5 shadow-sm">
            ...
            <div className="mt-8 h-[180px] flex items-end gap-2">
              {bars.map((bar, i) => (
                <div
                  key={i}
                  className="flex-1 rounded-t-xs bg-gradient-to-b from-violet-500 to-violet-700"
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <div className="flex items-start justify-between">
                ...
                <Link href="/Admin/WalletTransaction">
                  <button className="text-[16px] font-medium text-violet-700">
                    View All
                  </button>
                </Link>
              </div>
            ...
            <div className="bg-white  rounded-2xl p-5 shadow-sm">
              <div className="flex items-start justify-between">
                ...
                <Link href="/Admin/UserManagement">
                  <button className="text-[16px] whitespace-nowrap font-medium text-violet-700 text-start">
                    Manage Users
                  </button>
                </Link>
              </div>
            ...
            <div className="bg-white  rounded-2xl p-5 shadow-sm">
              <div className="flex itmes-start justify-between">
                ...
                <Link href="/Admin/LiveSession">
                  <button className="text-[17px] font-medium text-violet-700">
                    View All
                  </button>
                </Link>
              </div>
                ...
                {sessions.map((item, i) => (
                  <div key={i} className="flex justify-between items-center">
                    <div className="flex gap-3 items-center">
                      <div className="w-9 h-9 rounded-full bg-gradient-to-r from-[#FFF7CC] to-[#F3E1FF] text-violet-700 flex items-center justify-center text-[14px] font-medium">
                        PS
                      </div>
