        ...
        <div key={i} className="mb-6">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="w-[40px] h-[40px] rounded-full bg-gradient-to-r from-[#FFF7CC] to-[#F3E1FF] flex items-center justify-center text-purple-600 font-medium">
                {item.rank}
              </div>
            ...
            <div className="text-right">
              <p className="text-purple-600 font-medium text-[15px]">₹9,000</p>
