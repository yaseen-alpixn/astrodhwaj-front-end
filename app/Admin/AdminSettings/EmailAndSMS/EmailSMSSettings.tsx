  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        {/* Button */}
        <button className="border border-[#4898E1]/30 text-[#4898E1] hover:bg-[#4898E1]/5 px-4 py-2 rounded-[8px] text-[14px] transition-colors">
      ...
      <div className="flex justify-end">
        <button className="bg-[#4898E1] hover:bg-[#4898E1]/90 text-white px-6 py-2 rounded-[8px] transition-colors">
