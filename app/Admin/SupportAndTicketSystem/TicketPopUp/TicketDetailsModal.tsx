        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <div>
            ...
            <div className="space-y-4">
              {/* USER MESSAGE */}
              <div className="max-w-[70%] rounded-xl bg-[#4898E1]/10 p-4">
                <div className="flex items-center gap-2 mb-2">
                  <div className="h-8 w-8 flex items-center justify-center rounded-full bg-[#4898E1] text-white text-sm">
                    R
                  </div>
                  <div>
        ...
        <div className="sticky bottom-0 border-t bg-white p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <button className="rounded-md bg-[#4898E1] px-5 py-2 text-white">
                Send Message
              </button>
            </div>
          </div>
