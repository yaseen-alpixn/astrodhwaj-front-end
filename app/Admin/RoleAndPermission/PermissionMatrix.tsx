      ...
      <div className="mb-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="relative w-full md:max-w-[300px]">
          ...
          <input
            ...
            className="w-full h-[42px] border rounded-lg pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
        </div>
      </div>
              ...
              >
                ...
                <td className="p-3">
                  <div className="flex flex-wrap justify-center gap-2">
                    ...
                    <Tag label="View" color="bg-purple-100 text-purple-700" />
