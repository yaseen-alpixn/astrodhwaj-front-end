        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between rounded-xl bg-gray-100 p-4">
            ...
            <div className="flex gap-2">
              <span className="rounded-full bg-[#4898E1]/10 px-3 py-1 text-sm text-[#4898E1]">
                Horoscope
              </span>
          ...
          <div className="mt-6 rounded-xl border p-4">
            ...
            {/* SCORE */}
            <div className="mt-4 flex items-center justify-between rounded-xl bg-gradient-to-r from-yellow-100 to-[#4898E1]/10 p-4">
              <div className="flex items-center gap-2">
                <Star className="text-yellow-500" />
                <p className="font-medium">Overall Engagement Score</p>
              </div>
              <p className="text-2xl font-bold text-[#4898E1]">85%</p>
            </div>
          </div>
