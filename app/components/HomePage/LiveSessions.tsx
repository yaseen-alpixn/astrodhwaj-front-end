  ...
  return (
    <section className="mt-6 w-full">
      <div className="mx-auto sm:px-4 ">
        ...
        <div className="mt-3 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <div className="px-3 py-4 md:px-4 flex flex-col flex-grow">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full bg-[linear-gradient(135deg,#fff4cf_0%,#f5defa_100%)] text-[14px] font-medium text-[#222222]">
                      RS
                    </div>
                ...
                <div className="mt-auto flex items-center gap-[2px]">
                  <Link href="/User/JoinNow" className="flex-1">
                    <button className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#7b16c5] px-4 py-3 h-[35px] text-[13px] font-medium text-white transition-colors hover:bg-[#6910aa]">
                      {session.price}
                      <CirclePlay size={18} />
                    </button>
                  </Link>
