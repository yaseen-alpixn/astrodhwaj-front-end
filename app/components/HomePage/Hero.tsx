      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 sm:mt-10 sm:flex-row">
          <Link
            ...
            className="inline-flex min-w-[220px] items-center justify-center rounded-2xl bg-[#4898E1] px-8 py-4 text-lg font-medium text-white shadow-[0_18px_45px_rgba(122,30,177,0.28)] transition-transform hover:-translate-y-0.5"
          >
            Talk To Astrologer
          </Link>
          <Link
