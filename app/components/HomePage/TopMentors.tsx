...
function TopMentors() {
  return (
    <section className="w-full bg-white px-5 py-2 sm:px-8 sm:py-16 lg:px-10 lg:py-10">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {mentors.map((mentor, index) => (
            ...
            >
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 text-[0.95rem] text-[#585858]">
                <span className="inline-flex items-center gap-1">
                  <Star size={17} className="fill-[#f4c400] text-[#f4c400]" />
                  4.8
                </span>
                <span>&bull;</span>
                <span className="font-medium text-[#7b16c5]">
                  {mentor.rate}
                </span>
                <span>&bull;</span>
              ...
              <button
                type="button"
                className="mt-4 inline-flex w-full items-center justify-center rounded-xl border border-[#7b16c5] px-5 py-3 text-[1rem] font-medium text-[#111111] transition-colors hover:bg-[#faf5ff]"
              >
                View Profile
              </button>
            </article>
