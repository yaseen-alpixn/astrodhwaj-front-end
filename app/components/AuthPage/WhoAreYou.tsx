        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6">
          ...
          <div className="flex h-80 flex-col rounded-[24px] bg-white/95 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.3)] backdrop-blur-sm">
            ...
            <div className="flex justify-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#7a1eb1]">
            ...
            <Link
              href="/signup/user"
              className="mt-auto block w-full rounded-full bg-[#7a1eb1] py-2 text-center text-sm font-semibold text-white transition-all hover:bg-[#6a1a9f] active:scale-95"
            >
              Continue as User
            </Link>
          </div>
