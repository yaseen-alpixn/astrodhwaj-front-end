    ...
    <div className="w-full space-y-4">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 min-h-[108px] bg-white rounded-[15px] shadow-sm p-4 flex items-center gap-4">
          <Image src="/images/User.png" width={22} height={22} alt="Total consultations icon" />

          <div>
            <p className="text-[20px] font-bold text-purple-600">1312</p>
        ...
        <div className="flex-[2] grid grid-cols-1 sm:grid-cols-3 gap-4">
          {sessions.map((card, i) => (
            ...
            >
              ...
              <p className="text-[16px] font-semibold mt-2">{card.title}</p>
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 min-h-[108px] bg-white rounded-[15px] shadow-sm p-4 flex items-center gap-4">
          ...
          <div>
            <p className="text-[20px] font-bold text-purple-600">₹3,28,000</p>
            <p className="text-[12px] text-gray-500">Total Earnings</p>
          </div>
        </div>

        {/* Average Card */}
        <div className="flex-[2] min-h-[108px] rounded-[15px] p-5 relative overflow-hidden bg-gradient-to-r from-orange-400 via-red-400 to-pink-500 text-white">
