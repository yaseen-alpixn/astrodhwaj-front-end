...
export default function LiveSessionCard() {
  return (
    ...
    bg-gradient-to-r from-[#0180D5]  to-[#0040C1] text-white space-y-5 relative overflow-hidden"
      >
        {/* Icon */}
        ...
        <Link href="/Astrologer/LiveSessions">
          <button className="w-full h-[51px] rounded-[10px] bg-white text-[#4898E1] text-[13px] font-medium">
            Go Live Now ▶
          </button>
        </Link>
