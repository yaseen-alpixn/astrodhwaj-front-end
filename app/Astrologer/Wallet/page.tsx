  ...
  return (
    <main className="px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-6 xl:flex-row xl:items-start">
        {/* Wallet Card */}
        <section className="rounded-xl bg-gradient-to-r from-blue-600 to-purple-700 p-5 shadow-md xl:flex-[2] lg:h-[210px]">
          ...
          <button className="mt-5 h-11 w-full rounded-xl bg-white text-sm font-medium text-purple-700 transition hover:bg-gray-100">
            Withdraw Money
          </button>
        </section>
